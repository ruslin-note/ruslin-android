...
@Composable
fun Color.onLight(lightColor: Color, isDarkTheme: Boolean): Color =
    if (!isDarkTheme) lightColor else this

@Composable
fun Color.onDark(darkColor: Color, isDarkTheme: Boolean): Color =
    if (isDarkTheme) darkColor else this

@Stable
@Composable
@ReadOnlyComposable
fun Color.alwaysLight(isAlways: Boolean, isDarkTheme: Boolean): Color {
    val colorScheme = MaterialTheme.colorScheme
    return if (isAlways && isDarkTheme) {
        when (this) {
...
@Composable
@ReadOnlyComposable
fun Color.alwaysDark(isAlways: Boolean, isDarkTheme: Boolean): Color {
    val colorScheme = MaterialTheme.colorScheme
    return if (isAlways && !isDarkTheme) {
        when (this) {
            colorScheme.primary -> colorScheme.onPrimary
